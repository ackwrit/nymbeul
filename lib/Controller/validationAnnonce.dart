...
class validationAnnonce extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return homeValideAnnonce();
  }

}

class homeValideAnnonce extends State<validationAnnonce>{
  @override
                          ...
                          onPressed: (){
                            Navigator.push(context, MaterialPageRoute(
                                builder: (BuildContext context){
                                  return detailAnnonce(annonce: annon,validate: false,);
                                }
                            ));
                          }
                      )
  ...
  {
    return new Center(
      child: Text("Aucune annonce enregistrée dans cette rubrique"),
    );
  }
